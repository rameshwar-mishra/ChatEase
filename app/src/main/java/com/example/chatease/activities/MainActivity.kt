...
class MainActivity : AppCompatActivity() {
                ...
                if (currentUserDetails != null && otherUserDetails != null) {
                    ...
                    when (change.type) {
                        DocumentChange.Type.ADDED -> {
                            ...
                            Log.e("type", "ADDED: $recentChatDataList")
                            Log.e("type", "ADDED SIZE: ${recentChatDataList.size}")
                        }

                        DocumentChange.Type.MODIFIED -> {
                            if (modifiedChatData != null) {
                                Log.e("type", "Before MODIFIED: $modifiedChatData")
                            }

                            modifiedChatData = recentChatData
                            Log.e("type", "AFTER MODIFIED: $modifiedChatData")
                        }
                    ...
                    if (modifiedChatData != null) {
                        Log.d("RECENT CHAT DATA LIST", recentChatDataList.toString())
                    ...
                    Log.e("RECENT CHAT DATA LIST", recentChatDataList.toString())
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if (item.itemId == R.id.settingsIcon) {
            startActivity(Intent(this, SettingsActivity::class.java)) // Redirect to sign-in activity
        }
